...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-amber-100 dark:from-zinc-900 dark:to-zinc-800">
      ...
      <main className="container mx-auto px-4 py-16 flex flex-col items-center justify-center relative w-full ">

        
        <Image src="/idle.gif" alt="DePoop" width={300} height={300} />
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg md:text-xl mb-8 text-zinc-700 dark:text-zinc-300">
            A decentralized way to document your bathroom adventures and earn
            NFT achievements.
          </p>
          <LoginButton />
        </div>
        <div className="relative mt-24">
          <Iphone15Pro className="size-full" src="/phone.jpeg"/>
        </div>
...
const features = [
  {
    ...
    description:
      "Immutable records of your activity stored securely on the blockchain.",
  },
  {
    icon: FaTrophy,
...
const testimonials = [
  {
    quote:
      "Finally, a blockchain app that truly understands my daily routine. The NFT achievements make every visit memorable!",
    name: "Anonymous Alpha",
    title: "Power User",
  },
  {
    quote:
      "I've earned more sitting on the throne than I ever did trading crypto. This is the future!",
    name: "Crypto Chad",
    title: "Early Adopter",
  },
  {
    quote:
      "The geo-stamping feature has turned my world travels into a unique collection of achievements.",
    name: "Digital Nomad",
    title: "Globe Trotter",
  },
];
